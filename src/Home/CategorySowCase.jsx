...
const CategoryShowCase = () => {
    ...
    const filterItem = (category) => {
        if (category === "All") {
            ...
            const updatedItems = ProductData.filter((curElem) => curElem.cate === category);
        ...
        <div className="course-section style-3 padding-tb">
            ...
            <div className="container">
                ...
                <div className="section-wrapper">
                    <div className="row g-4 justify-content-center row-cols-xl-4 row-cols-lg-1 course-filter">
                        {items.map((product) => (
