...
const desc = "Eduaid theme number one world class university in the world. There are students studying here all the time.";
            ...
            <div className="footer-bottom">
                <div className="container">
                    <div className="section-wrapper">
                        <p>
                            &copy; 2023 <Link to="/">Shop Cart</Link> Designed by <a href="/" target="_blank">XYZ</a>
                        </p>
